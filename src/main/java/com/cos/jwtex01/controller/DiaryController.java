...
public class DiaryController {
	...
	public Diary post(@RequestParam Map<String, Object> param, @LoginUser Principal principal,
	...
	@ResponseBody
	@Transactional(isolation = Isolation.DEFAULT)
	public Diary post2(@RequestPart(value = "key") DiaryReqDto diaryReqDto,
			@RequestParam(value = "file", required = false) MultipartFile[] files, // upload file
			@LoginUser Principal principal) throws IOException {
	...
	@PostMapping("/edit/{id}")
	public void update(@PathVariable Long id, @LoginUser Principal principal,
			@RequestPart(value = "key") DiaryReqDto diaryReqDto, @RequestPart(value = "file") MultipartFile[] file) {
